const runSlider = () => {
  const slider = $(".best-seller-slider")
  const imageContainer = $(".best-seller-image-container")
  const leftArrow = $("#left-arrow")
  const rightArrow = $("#right-arrow")

  imageContainer.css("left", "-100%")

  leftArrow.click(() => {
      imageContainer.animate({
        left: '0'
      }, 500, () => {
        $(".best-seller-image-container .best-seller-image:last-child").prependTo(imageContainer)
        imageContainer.css('left', '-100%')  
    })
  })
  ...
  rightArrow.click(() => {
      imageContainer.animate({
        ...
        $(".best-seller-image-container .best-seller-image:first-child").appendTo(imageContainer)
        imageContainer.css('left', '-100%')  
    })
  })
}
